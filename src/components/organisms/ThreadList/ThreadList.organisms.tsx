...
// const ThreadList = ({ thread, handleAcceptClick }) => (
//   <div>
//     <div className='flex items-center w-full h-16 mt-4' key={thread.id}>
//       <div>
//         <img
...
//         <DeleteButton handleClick={() => handleAcceptClick(thread.id)} />
//       </div>
//     </div>
//   </div>
// );
